...
public class QuiltMapping extends AbstractMapping {

    public QuiltMapping() {
        super("Quilt", "https://maven.quiltmc.org/repository/release/org/quiltmc/quilt-mappings/&release&/quilt-mappings-&release&-tiny.gz", true);
    }
